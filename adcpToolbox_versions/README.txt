...
The version currently a part of the package is adcpToolbox_P01.R, which follows the BODC SeaDataNet P01 variable naming conventions and uses variable names reflecting that the data have been corrected for magnetic declination.
